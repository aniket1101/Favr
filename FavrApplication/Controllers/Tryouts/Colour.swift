...
extension EKColor {
    ...
    static var headerBackground: EKColor {
        return EKColor(light: Colour.BlueGray.c50.with(alpha: 0.95).light,
...
struct Colour {
    ...
    struct Purple {
        ...
        static let FavrPurple = EKColor(rgb: 0x56006d)
    }
    ...
    struct Orange {
        static let a1 = EKColor(rgb:0xFF8E33)
        static let a2 = EKColor(rgb:0xFF801A)
        static let a3 = EKColor(rgb: 0xff7200)
        static let a4 = EKColor(rgb:0xE66700)
        static let a5 = EKColor(rgb:0xCC5B00)
        static let a6 = EKColor(rgb: 0xB35000)
    }
    
    struct LightBlue {
        static let a700 = EKColor(rgb: 0x0091ea)
        static let FavrBlue = EKColor(rgb: 0x008dff)
        static let secondary = EKColor(rgb: 0x80c6ff)
    }
